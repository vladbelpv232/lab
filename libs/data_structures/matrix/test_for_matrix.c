...
void test_getMemMatrix () {
    test_for_getMemMatrix1();
    test_for_getMemMatrix2();
}

void test_for_getMemArrayOfMatrices1 () {
    int nMatrices = 4;
...
void test_for_getMemArrayOfMatrices2 () {
    int nMatrices = 8;
...
void test_getMemArrayOfMatrices () {
    test_for_getMemArrayOfMatrices1();
    test_for_getMemArrayOfMatrices2();
}

void test_for_freeMemMatrix1 () {
...
void test_freeMemMatrix () {
    test_for_freeMemMatrix1();
    test_for_freeMemMatrix2();
}

void test_for_freeMemMatrices1 () {
    matrix m1;
    m1.nRows = 2;
    m1.nCols = 2;
...
void test_for_freeMemMatrices2 () {
    matrix m1;
    m1.nRows = 9;
    m1.nCols = 1;
    m1.values = malloc(sizeof(int) * m1.nRows * m1.nCols);
