...
bool unordered_array_set_isInclusion(unordered_array_set const set1,
                                     unordered_array_set const set2) {
    if (set1.size > set2.size)
        return false;
...
bool unordered_array_set_isStrictInclusion(unordered_array_set const set1, unordered_array_set const set2) {
    if (set1.size >= set2.size)
        return false;
