...
bool ordered_array_set_isInclusion(ordered_array_set const set1,
                                   ordered_array_set const set2) {
    if (set1.size > set2.size)
        return false;
...
bool ordered_array_set_isStrictInclusion(ordered_array_set const set1,
                                         ordered_array_set const set2) {
    if (set1.size >= set2.size)
        return false;
